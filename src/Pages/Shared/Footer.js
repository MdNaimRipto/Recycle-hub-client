...
const Footer = () => {
    return (
        <>
            <footer className="footer mx-auto px-16 py-12 font-semibold bg-[#1a1a1a] text-white">
                <div>
                    <span className="footer-title">Useful Links</span>
                    <Link className="link link-hover">Home</Link>
                    <Link className="link link-hover">All Cars</Link>
            ...
            <footer className="footer mx-auto px-10 py-8 border-t bg-[#1a1a1a] text-white font-semibold border-base-300">
                <div className='mx-auto container flex items-center justify-between'>
                    <div className="items-center grid-flow-col">
                        <p>Copyright © 2023. All Right Reserved to Recycle Hub. </p>
                    </div>
